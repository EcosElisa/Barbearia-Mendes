...
public class ClientesController {
    ...
    public void cadastrarClientes() throws SQLException {
        ...
        try (Connection conn = new Conexao().getConnection();
            ...
            if (cliente.getName().isEmpty() || cliente.getEmail().isEmpty() || cliente.getTelefone().isEmpty()|| cliente.getEndereco().isEmpty() || cliente.getCpf().isEmpty()) {
                ...
                if (count > 0) {
                    ...
                    enviaParaOBanco.setString(1, cliente.getName());
